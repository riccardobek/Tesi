...
\todo grafica di base del progetto finale lato web frontend
...
%Il tipo di architettura da adottare è lasciata a discrezione dello stagista. Tuttavia, da InDe una struttura abbastanza rapida e semplice da implementare e manutenere risulta essere quella Event-Driven e in azienda questa tecnologia viene spesso adottata.

%Il modello di architettura Event-Driven è un modello di architettura asincrona distribuito utilizzato per produrre applicazioni altamente scalabili. Tale modello consiste di due topologie principali, mediator e broker. 
%In questo caso verrà adoperata la Mediator Topology.

%\begin{figure}[!h] 
%	\centering 
%	\includegraphics[width=0.8\columnwidth]{Event-Driven} 
%	\caption{Architettura Event Driven: Mediator Topology}
%	\label{EventDriven}
%\end{figure}
