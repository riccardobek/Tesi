...
Prima della nascita di \azienda\, è nata Yallpa s.r.l., una azienda dedita alla business intelligence. L'azienda in questione procedeva alle sue analisi adottando Access, Microsoft SQL Server e non elargiva alcun software per la gestione dei dati. Due impiegati si sono accorti che offrire un prodotto costruito con un certo criterio può facilitare notevolmente la Business Intelligence, così è iniziato un movimento alla ricerca di un'applicazione che permettesse la creazione di applicazioni gestionali e si è arrivati a \inde. 

\paragraph*{}Nel 2016 nasce, dall'unione delle idee dei due impiegati e un terzo membro già esperto di \inde\,\azienda\. I tre erano e sono ad oggi convinti fortemente nei vantaggi tecnologici ed economici che l'implementazione mediante strumenti di sviluppo rapido porta ai propri clienti. All'inizio la Business Intelligence è stata messa da parte per dedicarsi alla realizzazione di software con \inde\. Dopo 2 anni, raggiunta una certa stabilità e un buon numero di clienti, si è evoluta ed ha iniziato ad esplorare l'ambito della Business Intelligence  affidandosi a Yallpa s.r.l, oggi partner strategico dell'azienda. 
